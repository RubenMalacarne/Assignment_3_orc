...
class TriplePendulumMPC:
    ...
    def set_initial_state_list(self):
        ...
        return qs, dqs, qs + phi, dqs2, q3, dqs3
    ...
    def simulation(self, 
        ...
        for current_state in range(number_init_state):
            self.q0 = np.array([self.q1_list[current_state][0], self.q2_list[current_state][0],self.q3_list[current_state][0]])
            self.dq0= np.array([self.v1_list[current_state][0], self.v2_list[current_state][0],self.v3_list[current_state][0]])
            if (config_initial_state is not None and config_initial_state.size > 0):
                self.q0  = np.array([config_initial_state[0], config_initial_state[1],config_initial_state[2]])
                self.dq0 = np.array([config_initial_state[3], config_initial_state[4],config_initial_state[5]])
            ...
            self.state_buffer.append ([self.q1_list[current_state][0], self.q2_list[current_state][0],self.q3_list[current_state][0],self.v1_list[current_state][0], self.v2_list[current_state][0],self.v3_list[current_state][0]])
...
if __name__ == "__main__":
    ...
    mpc_double_pendulum = TriplePendulumMPC()
